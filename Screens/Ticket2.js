...
export default function Ticket2({ navigation }) {
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.card1_1}>
                    <Text style={{ fontSize: wp('5%') ,color :'rgba(85,158,132,0.62)' , fontFamily : 'Cairo-Bold',right :wp ('10%') }}> التذاكر المرسلة : 5 </Text>
                   


                </View>
                <View style={styles.card1_2}>
                <Text style={{ fontSize: wp('5%') ,color :'rgba(85,158,132,0.62)'  , fontFamily : 'Cairo-Bold',}}> التذاكر المستبعدة : 1 </Text>
             <Image  
